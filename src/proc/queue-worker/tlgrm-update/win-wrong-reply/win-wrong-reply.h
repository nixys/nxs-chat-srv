...
nxs_chat_srv_err_t		nxs_chat_srv_p_queue_worker_tlgrm_update_win_wrong_reply_runtime		(nxs_chat_srv_m_user_ctx_t *user_ctx, size_t chat_id, nxs_buf_t *response_buf);
