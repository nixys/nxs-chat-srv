...
nxs_chat_srv_err_t		nxs_chat_srv_p_queue_worker_tlgrm_update_win_issue_created		(nxs_chat_srv_u_db_sess_t *sess_ctx, size_t chat_id, size_t message_id, nxs_chat_srv_m_tlgrm_update_t *update, nxs_buf_t *response_buf);
