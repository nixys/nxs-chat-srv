...
nxs_chat_srv_err_t		nxs_chat_srv_u_rdmn_issues_create		(nxs_chat_srv_u_rdmn_issues_t *u_ctx, size_t project_id, size_t priority_id, nxs_string_t *subject, nxs_string_t *description, nxs_bool_t is_private, size_t *new_issue_id, nxs_string_t *api_key);
nxs_chat_srv_err_t		nxs_chat_srv_u_rdmn_issues_add_note		(nxs_chat_srv_u_rdmn_issues_t *u_ctx, size_t issue_id, size_t assigned_to_id, nxs_string_t *note, nxs_bool_t private_notes, size_t status_id, nxs_string_t *api_key);
