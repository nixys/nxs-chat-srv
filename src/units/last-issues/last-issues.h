...
nxs_chat_srv_err_t			nxs_chat_srv_u_last_issues_get			(nxs_chat_srv_u_last_issues_t *u_ctx, size_t tlgrm_userid, size_t rdmn_userid, nxs_string_t *user_api_key, size_t *rdmn_last_issue_id, nxs_string_t *issue_subject, nxs_string_t *issue_project_name);
