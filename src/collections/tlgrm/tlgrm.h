...
nxs_chat_srv_err_t			nxs_chat_srv_c_tlgrm_webhookinfo_result_pull_json	(nxs_chat_srv_m_tlgrm_webhookinfo_t *webhookinfo, nxs_bool_t *status, nxs_buf_t *json_buf);
