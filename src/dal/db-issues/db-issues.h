...
nxs_chat_srv_err_t		nxs_chat_srv_d_db_issues_get		(nxs_chat_srv_d_db_issues_t *d_ctx, size_t tlgrm_chat_id, size_t tlgrm_message_id, nxs_string_t *value);
nxs_chat_srv_err_t		nxs_chat_srv_d_db_issues_put		(nxs_chat_srv_d_db_issues_t *d_ctx, size_t tlgrm_chat_id, size_t tlgrm_message_id, nxs_string_t *value);
