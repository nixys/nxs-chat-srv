...
nxs_chat_srv_err_t			nxs_chat_srv_d_rdmn_issues_add_comment		(size_t issue_id, size_t assigned_to_id, nxs_string_t *note, nxs_bool_t private_notes, size_t status_id, nxs_array_t *custom_fields, nxs_string_t *user_api_key, nxs_http_code_t *http_code, nxs_buf_t *out_buf);
